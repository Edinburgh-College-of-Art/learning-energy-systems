...
function loadSubjects() {
    ...
    var sub = new Subject(window.g_leftMargin + window.g_elementMargin,
            window.g_heightUnit + window.g_topMargin * 4, r, w, h, 1, 1, "Math", 90);
    var sub1 = new Subject(window.g_leftMargin + window.g_elementMargin,
            window.g_heightUnit*2 + window.g_topMargin * 4, r, w, h, 2, 2, "Geography", 10);
}
