...
function loadData() {
                window.g_title = "Computer Science";
                window.g_projectorTotal = 20;
                window.g_computerTotal = 20;
                window.g_lightTotal = 5;
                window.g_heaterTotal = 30;
                window.g_projectorTotalString = "0011000110";
                window.g_computerTotalString = "0011000110";;
                window.g_lightTotalString = "100000000";
                window.g_heaterTotalString = "111111000";
                initialise();
